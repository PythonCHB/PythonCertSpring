...
def main() :
    if TEST :
        ...
        try :
            ...
            print "seconds threw an AssertionError %s as it should have" % e
        else :
            print "seconds DID NOT throw an AsserionError but it should have"

        print "Should be %d is %d" % (34*3600+12*60+11, seconds(t1) )
